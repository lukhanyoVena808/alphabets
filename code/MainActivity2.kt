...
class MainActivity2 : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val display = sharedPreferences.getString("button808",null)
        Toast.makeText(this@MainActivity2, "$display", Toast.LENGTH_SHORT).show()
...
//            myIntent()
    ...
    override fun onPause(){
        super.onPause()
        val theIntent = Intent(this, MainActivity::class.java)
        theIntent.putExtra(getString(R.string.intent2), nextImg)
    ...
    override fun onDestroy() {
        super.onDestroy()
        Toast.makeText(this@MainActivity2, "Hey Lux MAN", Toast.LENGTH_SHORT).show()
